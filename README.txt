...
Version 1.7.2:
More colored INFO and WARN messages
Standart debug level = 4, not 5 (No DEV Messages)
...
Version 1.7:
Added new config node - Max Balance
Fixed Start on 1.6 - 1.7.10
Fixed Start on Latest Spigot Patch
Minor bug fixes
