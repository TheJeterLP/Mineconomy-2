...
public class Currency {
    ...
    public static void load() {
        ...
        if (!currencyFile.exists()) {
            IOH.log("Currency file not found...", IOH.DEV);
            Bukkit.getConsoleSender().sendMessage("§9[Mineconomy] §cCurrency file not found...");
            currencies.set("Currencies", "");
            currencylist.add("Dollars");
            currencyvalue.put("Dollars", 1.0D);
            defaultCurrency = "Dollars";
            currencies.set("Physical", "");
            IOH.log("Currency file created!", IOH.DEV);
            Bukkit.getConsoleSender().sendMessage("§9[Mineconomy] §aCurrency file created!");
            save();
        }

        IOH.log("Loading Currency file...", IOH.DEV);
        Bukkit.getConsoleSender().sendMessage("§9[Mineconomy] §fLoading Currency file...");

        reload();

        IOH.log("Currency file loaded!", IOH.DEV);
        Bukkit.getConsoleSender().sendMessage("§9[Mineconomy] §fCurrency file loaded!");
    }
